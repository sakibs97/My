        ...
        <section className='lg:py-16'>
            <div className="grid grid-cols-1 sm:grid-cols-12">
                <motion.div
                    ...
                    className="col-span-8 place-self-center text-center sm:text-left justify-self-start h-[400px] md:h-[590px]">
                ...
                <motion.div
                    ...
                    <div className="rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative ">
                        <Image src="/images/hero-image.png" alt='hero-image'
                            className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 rounded-full w-[220px] h-[220px] lg:w-[350px] lg:h-[350px]"
